...
const EXPERIMENTAL_NOTICE = "🧪 Experimental: This provider is under active development and may break without warning. Behaviour, models, and authentication can change between releases.";
...
export const FREE_PROVIDERS = {
  ...
  codebuddy: { id: "codebuddy", alias: "cb", name: "CodeBuddy", icon: "smart_toy", color: "#006EFF", image: "/providers/codebuddy.svg", deprecated: true, deprecationNotice: RISK_NOTICE, website: "https://www.codebuddy.ai", notice: { signupUrl: "https://www.codebuddy.ai/login" } },
  ...
  "1min-ai": { id: "1min-ai", alias: "1min", name: "1min AI", icon: "bolt", color: "#0EA5E9", deprecated: true, deprecationNotice: RISK_NOTICE, website: "https://app.1min.ai", notice: { signupUrl: "https://app.1min.ai" }, serviceKinds: ["llm"] },
  ...
  "opencode-free": { id: "opencode-free", alias: "ocf", name: "OpenCode Free", icon: "terminal", color: "#E87040", textIcon: "OC", image: "/providers/opencode.png", noAuth: true, passthroughModels: true, modelsFetcher: { url: "https://opencode.ai/zen/v1/models", type: "opencode-free" } },
...
export const APIKEY_PROVIDERS = {
  ...
  opencode: { id: "opencode", alias: "oc", name: "OpenCode", icon: "terminal", color: "#E87040", textIcon: "OC", website: "https://opencode.ai/auth", notice: { text: "OpenCode API key for the OpenAI-compatible Zen endpoint.", apiKeyUrl: "https://opencode.ai/auth" }, passthroughModels: true, modelsFetcher: { url: "https://opencode.ai/zen/v1/models", type: "opencode-free" } },
...
export const WEB_COOKIE_PROVIDERS = {
  ...
  "gemini-web": { id: "gemini-web", alias: "gmw", name: "Gemini Web", icon: "auto_awesome", color: "#4285F4", textIcon: "GW", experimental: true, experimentalNotice: "🧪 Reverse-engineered Gemini web protocol. Cookies usually last 1–4 weeks before needing a re-paste. Heavy automated use can flag the Google account within hours; light use lasts months. Always use a burner account.", authType: "cookie", authHint: "Paste your full Cookie header from gemini.google.com (DevTools → Network → any request → Request Headers → Cookie). We extract the 6 needed cookies automatically.", hasProviderSpecificData: true, website: "https://gemini.google.com", serviceKinds: ["llm"], notice: { text: "Use a burner Google account, not your primary. Free accounts work for Flash models; gemini-3.1-pro requires a Gemini Advanced subscription cookie or it silently routes to Flash.", signupUrl: "https://gemini.google.com" } },
};
