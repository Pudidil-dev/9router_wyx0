...
export default function NineRemotePromoModal({ isOpen, onClose }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm rounded-[14px] overflow-hidden shadow-app-elev fade-in flex flex-col bg-surface border border-border-subtle">
        {/* Header */}
        ...
        <div className="px-7 py-7 pb-9 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-2 text-center mt-2">
            <div className="w-14 h-14 rounded-[14px] flex items-center justify-center mb-1 bg-primary shadow-app-warm">
          ...
          <button
            ...
            className="w-full py-3 flex items-center justify-center gap-2 text-sm font-semibold text-white rounded-[10px] bg-primary hover:bg-primary-hover shadow-app-warm active:scale-[0.98] transition-all"
          >
