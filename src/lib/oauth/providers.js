...
function createCodeBuddyDeviceProvider(config) {
  return {
    config,
...
const PROVIDERS = {
  ...
  codebuddy: createCodeBuddyDeviceProvider(CODEBUDDY_CONFIG),
  "codebuddy-cn": createCodeBuddyDeviceProvider(CODEBUDDY_CN_CONFIG),
};
